...
Copy pods/resource/pod-level-resources.yaml to clipboard
apiVersion: v1
kind: Pod
metadata:
...
Yes No
Last modified June 23, 2026 at 9:22 PM PST: Fix incorrect ValidatingAdmissionPolicy reference (9c67be5e1b)
